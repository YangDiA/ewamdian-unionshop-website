package com.ewandian.unionshop.microservice.website.websitecore;
...
public class WebSiteCoreApp
{
    private static final Logger LOG = LoggerFactory.getLogger(WebSiteCoreApp.class);
    ...
    public static void main(String[] args) {
        SpringApplication.run(WebSiteCoreApp.class, args);
    }
}
