...
public class WebSiteController {
    ...
    public Result select(@RequestBody WebSiteDTO webSiteDTO, HttpServletRequest request) {
        Result result = new Result();

        try {
            PageEntity<WebSite> pageEntity = webSiteService.getPageEntity(webSiteDTO);
    ...
    @ResponseBody
    public Result update(@RequestBody WebSiteDTO webSiteDTO, HttpServletRequest request) {
        WebSite webSite = new WebSite();
        BeanUtils.copyProperties(webSiteDTO, webSite);
        try {
